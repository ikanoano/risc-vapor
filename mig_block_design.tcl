...
CONFIG.XML_INPUT_FILE {mig_a.prj} \
  ...
  connect_bd_intf_net -intf_net S_AXI_1 [get_bd_intf_ports S_AXI] [get_bd_intf_pins mig_7series_0/S_AXI]
  connect_bd_intf_net -intf_net mig_7series_0_DDR2 [get_bd_intf_ports ddr2_sdram] [get_bd_intf_pins mig_7series_0/DDR2]

  # Create port connections
  connect_bd_net -net aresetn_1 [get_bd_ports aresetn] [get_bd_pins mig_7series_0/aresetn]
